...
@Autonomous(group = "a", name="Prototype Cycle")
public class OBSVuiwesdy98r2hg extends LinearOpMode {
...
//        elevator.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
     ...
     //   TrajectorySequence trajectory1 = drive.trajectorySequenceBuilder(trajectory0.end())
       //         .splineToConstantHeading(new Vector2d(12, -62), Math.toRadians(34.39))
        ...
        TrajectorySequence trajectory2 = drive.trajectorySequenceBuilder(trajectory0.end())
        ...
        TrajectorySequence trajectory4 = drive.trajectorySequenceBuilder(trajectory3.end())
          ...
          // redo whole trajectory initialize system
        // add 180 degree turn
