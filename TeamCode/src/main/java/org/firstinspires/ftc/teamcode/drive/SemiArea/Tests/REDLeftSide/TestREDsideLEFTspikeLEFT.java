 ...
 */
@Config
@Autonomous(name ="LEFT side RED spike LEFT")
public class TestREDsideLEFTspikeLEFT extends LinearOpMode {
...
// left blue left spike
                .lineToConstantHeading(new Vector2d(25, 34))// error acounting is 5.5 --6.5in
