...
//score first
        TrajectorySequence ScorePath = drive.trajectorySequenceBuilder(new Pose2d(36, -64), Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(4, -31.00, Math.toRadians(-90)), Math.toRadians(90))
                .build();
        //pick second
        TrajectorySequence PickUpPath = drive.trajectorySequenceBuilder(new Pose2d(0, -31), Math.toRadians(270))
...
//score second
        TrajectorySequence ScorePath2 = drive.trajectorySequenceBuilder(new Pose2d(36, -64), Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(7, -29.00, Math.toRadians(270.00)), Math.toRadians(90))
                .build();
//ppick third
...
//score third
        ...
        TrajectorySequence ScorePath3 = drive.trajectorySequenceBuilder(new Pose2d(36, -64), Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(10, -28, Math.toRadians(270.00)), Math.toRadians(90))
                .build();
//pick fouth
...
//score fourth
        TrajectorySequence ScorePath4 = drive.trajectorySequenceBuilder(new Pose2d(36, -64), Math.toRadians(90))
                .splineToLinearHeading(new Pose2d(13, -26, Math.toRadians(270.00)), Math.toRadians(90))
                .build();
// machine leaening camera code techniques below
        ...
        elevator.setTargetPosition(1500); // 2000                 //FIRST SPECIMEN old:2000 put to all others
        elevator.setMode(DcMotor.RunMode.RUN_TO_POSITION); ///////////// Reduced by 1000
        elevator.setPower(0.9);
        elevator2.setTargetPosition(-1500);
        elevator2.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        elevator2.setPower(-0.9);
        sleep(100); // old 1000
        claw.setPosition(0.7);
